...
public class TestScanMetricsResultParser {
  ...
  public void extraFields() {
    ...
    scanMetrics.resultDataFilesByFormat().increment(FileFormat.AVRO.toString(), 51);
    scanMetrics.resultDataFilesByFormat().increment(FileFormat.ORC.toString(), 52);
    scanMetrics.resultDataFilesByFormat().increment(FileFormat.PARQUET.toString(), 53);
  ...
  public void roundTripSerde() {
    ...
    scanMetrics.resultDataFiles().increment(5L);
    scanMetrics.resultDataFilesByFormat().increment(FileFormat.AVRO.toString(), 1L);
    scanMetrics.resultDataFilesByFormat().increment(FileFormat.ORC.toString(), 2L);
    scanMetrics.resultDataFilesByFormat().increment(FileFormat.PARQUET.toString(), 3L);
    scanMetrics.resultDeleteFiles().increment(5L);
    scanMetrics.scannedDataManifests().increment(5L);
    scanMetrics.skippedDataManifests().increment(5L);
    scanMetrics.totalFileSizeInBytes().increment(1024L);

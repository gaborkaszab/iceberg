...
public class TestScanPlanningAndReporting extends TableTestBase {
  ...
  public void scanningWithMultipleDataManifests() throws IOException {
    ...
    assertThat(result.resultDataFilesByFormat().value(FileFormat.AVRO)).isEqualTo(0);
    assertThat(result.resultDataFilesByFormat().value(FileFormat.ORC)).isEqualTo(0);
    assertThat(result.resultDataFilesByFormat().value(FileFormat.PARQUET)).isEqualTo(3);
    ...
    assertThat(result.resultDataFilesByFormat().value(FileFormat.AVRO)).isEqualTo(0);
    assertThat(result.resultDataFilesByFormat().value(FileFormat.ORC)).isEqualTo(0);
    assertThat(result.resultDataFilesByFormat().value(FileFormat.PARQUET)).isEqualTo(1);
    assertThat(result.resultDeleteFiles().value()).isEqualTo(0);
  ...
  public void scanningWithDataFilesOfMixedFileFormats() throws IOException {
    ...
    assertThat(result.totalPlanningDuration().totalDuration()).isGreaterThan(Duration.ZERO);
    assertThat(result.resultDataFiles().value()).isEqualTo(3);
    assertThat(result.resultDataFilesByFormat().value(FileFormat.AVRO)).isEqualTo(1);
    assertThat(result.resultDataFilesByFormat().value(FileFormat.ORC)).isEqualTo(1);
    assertThat(result.resultDataFilesByFormat().value(FileFormat.PARQUET)).isEqualTo(1);
    assertThat(result.resultDeleteFiles().value()).isEqualTo(0);
    assertThat(result.skippedDataFiles().value()).isEqualTo(0);
    assertThat(result.skippedDeleteFiles().value()).isEqualTo(0);

...
public class SparkColumnUpdateWriteBuilder implements WriteBuilder {
  ...
  public Write build() {
    ...
    if (!updatedColumns.isEmpty()) {
      // sparkWriteSchema = filterSchemaForColumnUpdate(sparkWriteSchema, updatedColumns);
    }

    Schema writeSchema = validateOrMergeWriteSchema(table, sparkWriteSchema, writeConf);
  ...
  private Set<String> updatedColumns() {
    try {
      ...
      Set<String> updatedColumns = new java.util.HashSet<>();

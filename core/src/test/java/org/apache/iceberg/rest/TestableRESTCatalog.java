...
class TestableRESTCatalog extends RESTCatalog {
  ...
  TestableRESTCatalog(
    ...
    this(context, clientBuilder, Ticker.systemTicker());
  }
  ...
  protected RESTSessionCatalog createSessionCatalog(
      Function<Map<String, String>, RESTClient> clientBuilder) {
    // This is called from the RESTCatalog's constructor, 'ticker' member is not yet set, we have to
  ...
  public Cache<SessionIDTableID, TableWithETag> tableCache() {
    return sessionCatalog().tableCache();
  }
}
